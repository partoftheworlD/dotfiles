...
pacman -S tmux btop git vlc wget curl ttf-jetbrains-mono inter-font duperemove neovim gamescope lutris steam gamemode less spotify-launcher code gufw tuned cups splix obs-studio obsidian pacman-contrib tldr gnome-firmware fwupd --noconfirm > /dev/null 2>&1
