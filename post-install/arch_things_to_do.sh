...
pacman -Rsn $(pacman -Qs | grep -oP '/\K(firefox|htop|epiphany|totem|gnome-tour|snapshot|gnome-maps|rhytmbox|gnome-music|showtime|gnome-boxes|gnome-console|evolution|vim|vim-runtime|decibels)(?=\s|$)') 
