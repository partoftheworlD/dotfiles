...
dnf install -y tmux btop git wget curl jetbrains-mono-fonts rsms-inter-fonts duperemove btrfs-assistant neovim gamescope lutris steam distrobox gamemode gnome-tweaks splix tldr vlc libavcodec-freeworld
flatpak install -y heroic protonplus bazaar com.mattjakeman.ExtensionManager com.github.tchx84.Flatseal md.obsidian.Obsidian spotify
