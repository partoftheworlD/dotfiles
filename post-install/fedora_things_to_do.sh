...
flatpak install -y heroic protonplus bazaar com.mattjakeman.ExtensionManager org.freedesktop.Platform.ffmpeg-full com.github.tchx84.Flatseal md.obsidian.Obsidian spotify
